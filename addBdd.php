                ...
                if (isset($_POST['description']) && $_POST['description'] != "") {
                    ...
                    if (isset($_POST['ville']) && $_POST['ville'] != "") {
                        ...
                        if (isset($_POST['lat']) && $_POST['lat'] != "") {
                                        ...
                                        if (in_array($ext2, $allow_ext) || !isset($_POST['img2'])) {
                                            ...
                                            if (!empty($_FILES['img3'])) {
                                                ...
                                                if (in_array($ext3, $allow_ext) || !isset($_POST['img3'])) {
                                                    ...
                                                    $date = date("y.m.d");
                                                    //on ajoute longitude et lattitude
                                                    $lat = $_POST['lat'];
                                                    $lon = $_POST['lon'];
                            ...
                            $erreur = "Veuillez verifier que la position soit bien marqué sur la carte si vous avez juste rentré la ville cliqué sur le coté";
                        }
                    } else {
